...
namespace ReportWebApplication
{
    ...
    public partial class DesignerPage : System.Web.UI.Page
    {
        ...
        public static bool checkUser(string username, string password)
        {
            ...
            try
            {
                // PrincipalContext pc = new PrincipalContext(ContextType.Domain,"", "ldap://10.21.64.228/CN=Configuration,DC=corp,DC=unitel,DC=mn");
                PrincipalContext pc = new PrincipalContext(ContextType.Domain, "", "ldap://10.21.64.228/DC=corp,DC=unitel,DC=mn");
