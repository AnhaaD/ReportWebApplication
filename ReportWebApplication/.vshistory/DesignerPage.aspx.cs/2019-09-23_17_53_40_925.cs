...
namespace ReportWebApplication
{
    ...
    public partial class DesignerPage : System.Web.UI.Page
    {
        ...
        public static bool checkUser(string username, string password)
        {
            ...
            try
            {
                PrincipalContext pc = new PrincipalContext(ContextType.Domain,"", "CN=mungunsukh.p,OU=Mobile network maintenance unit,OU=Technical,OU=UN,DC=corp,DC=unitel,DC=mn");
